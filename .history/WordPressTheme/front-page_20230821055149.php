        ...
        <div class="news__inner inner">
          <?php /* 取得する投稿の条件 */ ?>
              <?php
                ...
                $the_query = new WP_Query($args); /* クエリの作成と発行をし、取得したデータを「$the_query」に格納 */ if ($the_query->have_posts()): /* もし、投稿がある場合 */ ?>
                ...
                <div class="news-content__info">
                  ...
                  <?php
					  ...
					  echo '<span class="news-content__category"'.$cat->slug.'">'.$cat[0]->name.'</span>';
					?>
                </div>
