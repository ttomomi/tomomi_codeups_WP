...
<section class="sub-blog bottom-sub-blog">
          ...
          <div class="sub-blog__container inner">
            <div class="sub-blog__contents">
              ...
              <div class="sub-blog__content">
                <?php if( get_field('blog_title2')): ?>
                  <h2 class="sub-blog__title2">
                  <?php the_field('blog_title2'); ?>
                  </h2>
                <?php endif; ?>
                <?php if( get_field('blog_text2')): ?>
                <p class="sub-blog__text">
...
<?php if ($prev): ?>
<a class="link__item" href="<?php echo $prev_url ?>">prev</a>
<?php endif; ?>

<a class="link__item" href="<?php echo esc_url(home_url('/blog/')) ?>">一覧</a>

<?php if ($next): ?>
<a class="link__item" href="<?php echo $next_url ?>">next</a>
<?php endif; ?>
